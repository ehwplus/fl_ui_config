          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              final Map<String, Color> colorMap = {
                ...
                if (colorPalette.errorDark != null) 'Error dark': colorPalette.errorDark!,
                'Success light': colorPalette.successLight,
                if (colorPalette.successDark != null) 'Success dark': colorPalette.successDark!,
                if (colorPalette.warningLight != null) 'Warn light': colorPalette.warningLight!,
                if (colorPalette.warningDark != null) 'Warn dark': colorPalette.warningDark!,
              };
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                ...
                                style: TextStyle(color: i % 2 == 0 ? fontColors.normal : fontColors.normalInverted),
                              ),
                            ),
                          ),
                        ],
