          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              final Map<String, Color> colorMap = {
                ...
                if (colorPalette.errorBackground != null)
                  'Error background': colorPalette.errorBackground!,
                'Success': colorPalette.success,
                if (colorPalette.successBackground != null)
                  'Success background': colorPalette.successBackground!,
                if (colorPalette.warning != null) 'Warn': colorPalette.warning!,
                if (colorPalette.warningBackground != null)
                  'Warn background': colorPalette.warningBackground!,
              };
