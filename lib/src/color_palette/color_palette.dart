...
class ColorPalette {
  ...
  Color getErrorColor(BuildContext context) {
    final areColorsExplicitForDarkModeGiven = brightness == Brightness.dark;
    final useLight = context.isLight || errorBackground == null || areColorsExplicitForDarkModeGiven;
    return useLight ? error : errorBackground!;
  }

  Color getSuccessColor(BuildContext context) {
    final useLight = context.isLight || successBackground == null || brightness == Brightness.dark;
    return useLight ? success : successBackground!;
  }

  Color? getWarningColor(BuildContext context) {
    final useLight = context.isLight || warningBackground == null || brightness == Brightness.dark;
